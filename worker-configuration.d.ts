/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface=CloudflareEnv` (hash: cee6ca8d4b1c8815f167978ebd8d95fb)
// Runtime types generated with workerd@1.20260730.1 2026-07-27 
interface __BaseEnv_CloudflareEnv {
	PAYLOADS: R2Bucket;
	DB: D1Database;
	EMAIL: SendEmail;
	PRIMARY_QUEUE: Queue;
	HAYASEND_DEPLOYMENT_ID: "local-proof";
	HAYASEND_PROVIDER: "cloudflare-email";
	HAYASEND_HEALTH_MODE: "ready";
	PRIMARY_QUEUE_NAME: "hayasend-local-primary";
	DLQ_QUEUE_NAME: "hayasend-local-dlq";
	EMAIL_EVENTS_QUEUE_NAME: "hayasend-local-email-events";
}
